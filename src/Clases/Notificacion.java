...
public class Notificacion {
    ...
    private Image image =new ImageIcon(getClass().getResource("/Imagenes/i48.png")).getImage() ;
    private final TrayIcon trayIcon = new TrayIcon(image, " Sistema  Hotel * LUCHO*  ", popup);
    //para el Timer
    private Timer timer;    
